...
desc 'Generate documentation for the quick_auction extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'QuickAuctionExtension'
...
desc 'Test the quick_auction extension.'
...
namespace :test do
  desc 'Functional test the quick_auction extension.'
  ...
  desc 'Unit test the quick_auction extension.'
